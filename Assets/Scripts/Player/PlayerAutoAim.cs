...
namespace Mascari4615
{
	public class PlayerAutoAim : MonoBehaviour
	{
		...
		private GameObject NearestTarget()
		{
			...
			foreach (var target in GameManager.Instance.EnemyDataBuffer.RuntimeItems)
			{
		...
		private IEnumerator AimLoop()
		{
			while (true)
			{
				var target = GameManager.Instance.EnemyDataBuffer.RuntimeItems.Count > 0 ? NearestTarget() : null;
